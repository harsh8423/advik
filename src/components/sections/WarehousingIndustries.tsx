...
import { LuShoppingBag, LuFactory, LuHardHat, LuCar, LuUtensilsCrossed } from 'react-icons/lu';
...
export default function WarehousingIndustries() {
    return (
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                        Providing specialized warehousing and transloading solutions across diverse sectors
                    </p>
                </motion.div>
