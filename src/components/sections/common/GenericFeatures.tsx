...
export default function GenericFeatures({ services, whenToChoose, benefits }: GenericFeaturesProps) {
    return (
            ...
            <div className="container mx-auto px-6 lg:px-16 space-y-20">
                ...
                <div>
                    <div className="text-center mb-12">
                        <h3 className="text-3xl font-display font-bold text-advik-navy mb-4">Our Services</h3>
