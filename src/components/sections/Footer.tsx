                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <div className="flex gap-4 mb-8">
                            <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary hover:text-white text-gray-400 transition-colors cursor-pointer">
