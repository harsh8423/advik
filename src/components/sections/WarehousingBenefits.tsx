...
import { LuClock, LuMonitor, LuArrowUpDown, LuShieldCheck, LuMapPin } from 'react-icons/lu';
...
const benefits = [
    {
        ...
        description: 'Reduce handling time and ensure faster movement of goods.'
    },
    {
        icon: LuMonitor,
        title: 'Advanced Technology',
        description: 'Integrated Warehouse Management Systems (WMS) for real-time inventory tracking.'
    },
    {
        icon: LuArrowUpDown,
        title: 'Scalable Solutions',
        description: 'Adaptable storage and transloading capacity as business needs grow or change.'
    },
    {
        icon: LuShieldCheck,
        title: 'Safety & Compliance',
        description: 'Adherence to industry standards for cargo security and worker safety.'
    },
    {
        icon: LuMapPin,
        title: 'Strategic Locations',
        description: 'Facilities near major transportation hubs for faster deliveries and logistics optimization.'
    }
];

export default function WarehousingBenefits() {
    return (
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-bold text-light mb-4">
                        Benefits of Choosing <span className="text-primary">Advik Freight</span>
                    </h2>
