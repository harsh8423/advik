                ...
                <div className="max-w-7xl w-full px-6 relative">
                    ...
                    <div className="relative grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div className="step-1 flex flex-col items-center text-center opacity-0 relative">
                            <div className="w-20 h-20 bg-white/10 rounded-full flex items-center justify-center mb-4 relative z-20 border border-white/20">
                            ...
                            <div className="md:hidden absolute top-20 left-1/2 -translate-x-1/2 w-1 h-32 bg-white/10 -z-10">
