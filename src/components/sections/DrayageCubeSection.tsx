                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="space-y-6 lg:order-2 order-2">
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                            Expert <span className="text-[#ff1a1a]">Drayage</span> Services
                        </h2>
                        ...
                        <div className="grid grid-cols-2 gap-6 pt-4">
                            <div className="space-y-2">
                                <div className="text-3xl font-bold text-[#ff1a1a]">2-Hour</div>
                            ...
                            <div className="space-y-2">
                                <div className="text-3xl font-bold text-[#ff1a1a]">98%</div>
                                <div className="text-sm text-gray-400">On-Time Rate</div>
                            </div>
                            <div className="space-y-2">
                                <div className="text-3xl font-bold text-[#ff1a1a]">GPS</div>
