        ...
        <section className="py-20 bg-background relative overflow-hidden">
            <div className="max-w-6xl mx-auto px-6 relative z-10">
                    ...
                    {values.map((value, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-6 hover:border-primary/50 hover:bg-accent/5 transition-all duration-300 group"
                            >
                ...
                <motion.div
                    ...
                    className="mt-16 bg-gradient-to-r from-primary/5 to-primary/10 border border-primary/20 rounded-2xl p-8"
                >
                    <div className="flex items-center gap-4 mb-4">
                        <Leaf className="w-10 h-10 text-primary" />
                        <h3 className="text-3xl font-bold text-foreground">Sustainability and Responsibility</h3>
                    </div>
