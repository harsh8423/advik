            ...
            <div className="container mx-auto px-6 relative z-10 pt-20">
                ...
                >
                    <div className="flex items-center gap-2 text-white/80 mb-6 text-sm font-medium tracking-wide uppercase">
                        ...
                        <span className="text-advik-red font-bold">Retail</span>
                    </div>

                    <h1 className="text-6xl md:text-8xl font-display font-bold text-white mb-8 leading-tight">
                        Retail <span className="text-transparent bg-clip-text bg-gradient-to-r from-advik-red to-orange-500">Logistics</span>
                    </h1>

                    <p className="text-xl md:text-2xl text-gray-200 max-w-2xl leading-relaxed font-light border-l-4 border-advik-red pl-6">
                        Agile solutions for the dynamic retail market. We keep your shelves stocked and customers happy with precision logistics.
                    </p>
                </motion.div>
            </div>
        </section>
