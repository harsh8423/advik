...
export default function DrayageCommitment() {
    const commitmentPoints = [
        'Experienced drivers trained in container handling',
        'Modern fleet equipped for efficient transport',
        'Real-time tracking and logistics optimization',
        'Trusted partner for seamless port-to-warehouse operations'
    ];
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-8 text-center">
                                Advik Freight ensures your drayage needs are handled with{' '}
                            ...
                            >
                                <p className="text-gray-400 mb-6">
                                    Our combination of experienced drivers, modern equipment, and advanced logistics technology
                                    makes us a trusted partner for seamless container transport operations.
                                </p>
                                <a
                                    href="/contact"
